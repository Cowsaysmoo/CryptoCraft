...
public class WalletInfo {
    ...
    public void createWalletOnJoin(CommandSender sender, String coin){
        if (sender instanceof Player) {
            try {
                Player player = (Player) sender;
                String StrURL = null;
                ...
                try {
                    if(conn.getResponseCode() < 400){
                        player.sendMessage(coin + " wallet created successfully!");
                    }
                    else{
                        BufferedReader in = new BufferedReader(
                        new InputStreamReader(conn.getErrorStream()));
    ...
    public void createWalletSingle(CommandSender sender, Command command, String label, String[] args){
        if (sender instanceof Player) {
            try {
                Player player = (Player) sender;
                String StrURL = null;
